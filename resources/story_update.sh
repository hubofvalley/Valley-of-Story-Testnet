...
echo -e "h. ${YELLOW}v1.5.1${RESET} (${GREEN}Horace - Mandatory Hardfork${RESET} Upgrade height: $(LC_NUMERIC='en_US.UTF-8' printf "%'d" $((realtime_block_height + 100))))"
...
case $choice in
    ...
    g)
        ...
        ;;
    h)
        update_version "v1.5.1" "https://github.com/piplabs/story/releases/download/v1.5.1" 14017000
        ;;
    #f)
        #batch_update_version
        #;;
